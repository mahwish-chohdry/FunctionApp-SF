...
namespace HubEvent.Function
{
    public static class IoTEventTriggerCSharp
    {
        ...
        */
        ...
        private static string notificationhubConnectionstring = "Endpoint=sb://nhub-terraform.servicebus.windows.net/;SharedAccessKeyName=DefaultFullSharedAccessSignature;SharedAccessKey=OgbFxnSwIOS7PxxtHpkZWjPffxwrYlpV+5YAOwm5PRo="; //notificationhub connection string
